...
This software is available under the **GNU Affero General Public License v3.0 (AGPLv3)** 
for open-source and personal use. The AGPLv3 grants you the right to use, modify, and 
distribute this software, provided that you comply with its terms — including the 
requirement to disclose source code when providing network-based services.

For organizations that cannot comply with the AGPLv3's requirements, a **commercial 
...
- Incorporate this software into a **closed-source** product or service
- Provide **SaaS / cloud-hosted services** based on this software without 
  disclosing your modifications
- Use this software in an **enterprise internal tool** where AGPLv3 compliance 
  creates legal or operational conflicts
- Distribute this software as part of a **proprietary offering**
- Need **private forks** that are not subject to the AGPLv3's source disclosure 
  requirement
